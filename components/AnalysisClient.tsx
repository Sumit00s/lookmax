    ...
    <>
      ...
      {appState === "done" && result && imageUrl ? (
        <div className="relative">
          ...
          {/* ── Full-screen auth wall (fixed, covers entire viewport) ── */}
          {!isLoggedIn && (
            <div
            ...
            >
              ...
              <div className="text-center mb-8 max-w-lg">
                ...
                <p className="text-sm sm:text-base text-white/60 font-medium">
                  Create a new account or sign in to get started.
                </p>
              </div>
              ...
              <button
                onClick={handleReset}
                className="mt-5 text-xs text-white/40 hover:text-white/70 transition-colors underline underline-offset-2"
              >
