        ...
        <div className="flex items-center gap-3">
          ...
          {status !== "loading" && session && (
            <div className="relative" ref={dropdownRef}>
              ...
              {/* Dropdown — minimal, no heavy shadow */}
              {dropdownOpen && (
                <div className="absolute right-0 mt-2 w-52 bg-[#faf9f6] dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden animate-fade-in">
                  {/* User info */}
